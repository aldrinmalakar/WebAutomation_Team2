...
public class BOATest extends WebAPI {
    ...
    @Test(dataProvider = "ExcelTEST", dataProviderClass = WebAPI.class)
    public void loginFunctionalitiesElements(String userId, String password) throws Exception {
        boaHmePage.loginFunctionalities(userId, password);
        boaHmePage.validateLoginFunctionalities();
    }

    @Test
    public void Logindbconnect() throws Exception {
        boaHmePage.loginUsingConnectDB();
        boaHmePage.validateLoginUsingConnectDB();

    }

    @Test
    public void getListOfLinksConnectDB() throws Exception {
        boaHmePage.getListOfLinks();
        boaHmePage.desktopListElements();
